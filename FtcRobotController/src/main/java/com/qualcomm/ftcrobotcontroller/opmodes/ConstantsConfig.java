...
public class ConstantsConfig {
    ...
    static final float RED_UP = 0.83f, RED_MID = 0.35f, RED_DOWN = 0.15f;// Red Pusher Zipline Trigger
    static final float BLUE_UP = 0.2f, BLUE_MID = 0.7f, BLUE_DOWN = .9f;// Blue Pusher Zipline Trigger
    ...
    static final float ENCODER_CPI = 116f;// ~116 counts/inch with Hugo's treads with thicker wheels.
