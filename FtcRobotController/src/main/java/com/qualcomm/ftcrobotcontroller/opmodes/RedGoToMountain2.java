...
public class RedGoToMountain2 extends OpMode{
    private enum State {
        DRIVE_TO_BASE,
        TURN_TO_MOUNTAIN,
        GO_UP_MOUTAIN
    ...
    public void loop() {
        switch (currentState){
            case DRIVE_TO_BASE:
                ...
                if(motorRight.getCurrentPosition() < (55 * ENCODER_CPI)){
            ...
            case TURN_TO_MOUNTAIN:
                ...
                if(sensorGyro.getHeading() != 270){
                    if(Math.abs(adjHeading(sensorGyro.getHeading()) + 90) > 50){
                        motorLeft.setPower(1);
                        motorRight.setPower(-1);
                    }else{
            ...
            case GO_UP_MOUTAIN:
                ...
                telemetry.addData("Distace (inches)", motorRight.getCurrentPosition() / ENCODER_CPI);
                if(motorRight.getCurrentPosition() < (98 * ENCODER_CPI)){
                    motorRight.setPower(1);
                    motorLeft.setPower(1);
                }else{
